var rawDataRefed = {
  ...
  "PetrVyletal": {
    "jmeno": "Petr Vyleťal",
    "jmenoTituly": "Ing. Petr Vyleťal, Ph.D.",
  ...
  "RadekSkarnitzl": {
    ...
    "jmenoTituly": "doc. Mgr. Radek Skarnitzl, Ph.D.",
  ...
  "DanaDrabova": {
    ...
    "anotace": "Symboly spojované v pravé polovině našeho mozku s jadernou energií a zářením malují obraz světa po jaderné havárii. Naše mysli na něm usilovně pracovaly více než šedesát let za vydatné pomoci katastrofických románů a filmů, článků v rádoby seriózním i otevřeně bulvárním tisku a televizních programů. Za pouhé jedno století jsme se však naučili záření široce využívat. Dnes bychom se bez jaderných technologií stěží obešli. Užitek nám přinášejí v medicíně, průmyslu, energetice, zemědělství a mnoha dalších oborech. Nic na světě však není prosto rizika. Více než sto let radiologického bádání přineslo detailní informace o biologických mechanismech, jimiž záření působí na zdraví. Je známo, že záření vyvolává projevy na úrovni buněčné působící zánik buněk nebo buňky modifikuje zpravidla přímým účinkem na vlákna deoxyribonukleové kyseliny v chromosomech. Znalost působení záření na naše tělo nám umožňuje udělat si z jaderných technologií dobrého sluhu, který vždy bude přinášet více užitku než škody.",
  ...
  "TerezaGafnaVanova": {
    ...
    "cas": "",
    "nazev": "Tělo a tělesnost v judaismu\n",
    "anotace": "Židovství je známé svým zájmem o materiální svět obecně – člověk a jeho tělesnost nejsou žádnou výjimkou. Jaké jsou náboženské a kulturní principy, které určují, jak se židé ke svým tělům chovají a vztahují? Existují specifická pravidla, která se týkají ženského těla a ženských tělesných projevů a potřeb? Přijďte si poslechnout přednášku přímo od zdroje – od ortodoxní židovky, která tím, o čem vypráví, také skutečně ve svém každodenním životě žije.",
  ...
  "FilipMatejka": {
    "jmeno": "Filip Matějka",
    "jmenoTituly": "RNDr. Filip Matějka, Ph.D.",
    "cas": "17.11. 15-17",
  ...
  "TomasChytka": {
    ...
    "medailon": "\nMUDr. Tomáš Chytka odmaturoval na pražském Gymnáziu Jana Keplera v roce 1984. Po vystudování univerzity se stal neurochirugem a je jedním z mála lékařů v této zemi, který operuje pomocí Leksellova gama nože v Nemocnici Na Homolce. Mimo to organizuje různé běhy pro zdraví a kondici a pořádá všemožné autorské výstavy. "
  },
  "LukasCerny": {
    "jmeno": "Lukáš Černý",
    "jmenoTituly": "",
  ...
  "JanCerny": {
    ...
    "anotace": "Mikrochimerismus – znejistění výrokem, že naše těla jsou složena z trochu jiných částí, než si myslíme. Učebnicovou jistotou bylo, že jsme složeni z buněk, které vznikly dělením a diferenciací zygoty (vzniklé po oplození vajíčka spermií), v níž se zkombinoval genetický materiál našeho otce a naší matky. Co ale tuto teorii zpochybnit tím, když řekneme, že na počátku embryonálního vývoje splynou celá embrya a takto vzniklý jedinec je vlastně mozaikou buněk pocházejících ze dvou různých těl, se všemi možnými důsledky z toho vyplývajícími? Zabýváním se migrací buněk z jednoho těla do druhého, a to buď z embrya do matky či naopak, je zajímavá cesta poznáním něčeho naprosto nového.",
  ...
  "PavelKlusak": {
    ...
    "medailon": "Pavel Klusák (47) je hudební publicista, zaměřený zejména na nezávislý rock a nonartificiální styly obecně. Jeho články vynikají zejména svou osobitostí a neotřelým jazykem. Za dobu svého publicistického působení se jeho jméno objevilo například v Lidových novinách, MF DNES nebo Respektu. Vedle tištěné tvorby spolupracuje Klusák i s Českým rozhlasem, kde se podle svých slov snaží posluchačům sdělit, že naslouchat se dá líp, než si člověk myslí a pomáhá k lepšímu poznání světa. Dále zastává pozici dramaturga hudebního doprovodného programu na Mezinárodním festivalu dokumentárních filmů v Ji.hlavě a na svém hudebním labelu „Klíče“ vydal např. Debutové album Tomáše Hanáka.\n"
  },
  "JanKozak": {
    "jmeno": "Jan Kozák",
    "jmenoTituly": "Mgr. Jan Kozák, Ph.D.",
    "cas": "17.11-10-12",
  ...
  "PetrZewlakkVrabec": {
    ...
    "nazev": "",
    "anotace": "",
    "medailon": "Petr „Zewlakk“ Vrabec vystudoval geodézii a pět let se živil jako zeměměřič. Dnes ale pracuje jako barman v Unijazzu a věnuje se práci na statku ve Vlčkovicích. Hlavně se ale věnuje fotografii. Je znám jako náš přední aktivistický fotograf. Letos získal několik nominací na cenu Czech press foto se souborem fotografií z demonstrace před uhelnými doly. Je hrdý Žižkovan a sám se také často do občanských aktivit zapojuje. K přezdívce Zewlakk přišel na střední škole. Začali mu tak říkat spolužáci vlastně jen pro to, že ignoroval módní diktát. Dnes se stala jeho běžným jménem."
  },
  "LucieSramkova": {
    ...
    "anotace": "Co je cesta individuace, co se mi snaží říci moje sny, co je nevědomí?\nFilozofové i psychologové mluví o duši, psýše, jejíž rozvoj máme ve svých rukou. Můžeme ji usměrnit k nejvyšším citům a myšlenkám a být sami sebou, nebo se nechat vláčet okolnostmi a druhými lidmi. Můžeme své myšlenky a emoce nechat plynout a být jejich otroky, nebo se můžeme naučit nad nimi získat kontrolu kdykoliv budeme chtít nebo potřebovat. Tím je nejen můžeme ovládat, ale i formovat a rozvíjet. \nKlasická psychologie, na kterou navazuje i C.G.Jung, nás učí o nástrojích psýchy – duše, které máme více či méně rozvinuté, ale které můžeme trénovat. Jedná se např. o pozornost, paměť, inteligenci, imaginaci a vůli, na něž zaměříme praktickou část workshopu.",
    "medailon": "MUDr. Lucie Šrámková je lektorkou mezinárodní neziskové organizace Nové Akropolis (kde se pohybuje již 20. rokem). Zabývá se psychologií a filosofií Východu a Západu a pořádá kurzy rétoriky a symbolismu starověkých kultur."
  },
  "SimonPanek": {
    "jmeno": "Šimon Pánek",
    "jmenoTituly": "",
  ...
  "HelenaVavrova": {
    ...
    "anotace": "Zásady imunitní obrany našeho vnitřního prostředí a jejího selhání v případě autoimunitních nemocí, např. Diabetu mellitu 1.st",
  ...
  "FilmovaNoc":{
      ...
      "ref": "FilmovaNoc",
      "spans": 5,
	  "anotace":"Dva večery voyerismu. Nazírání na těla oblečená i svlečená, krásná i ošklivá, živá i mrtvá. Těla se budou hýbat, ohýbat i prohýbat, budou se měnit, tančit, skrývat, exhibovat či prodávat. Tělesné prožitky a závislosti. To vše na letošní filmové noci Symposionu GJK.",
	  "medailon":"",
	  "lide":[
	  {"jmeno":"Katka",
	  "anotace":"Film Heleny Třeštíkové je unikátním časosběrným dokumentem, mapujícím čtrnáct let v životě mladé narkomanky a jejího marného zápasu se závislostí. Film zaznamenává ve svém filmu rok za rokem Katčin sestup níž a níž na spirále krádeží, prostituce, fyzického i psychického chátrání, na spirále, přerušované jen občasným vzepětím naděje a odhodlání s drogou skoncovat."},
	  {"jmeno":"Paris is Burning",
	  "anotace":"Kultovní dokumentární film o Newyorkské queer scéně osmdesátých let se zaměřuje na umění dragu, tance vogue a tragické osudy tehdejší LGBT komunity."},
	  ...
	  {"jmeno":"Tangerine",
	  "anotace":"Po propuštění z vězení se prostitutka Sin-dee Rella dozvídá že její přítel/pasák jí byl nevěrný, proto se svou nejlepší přítelkyní vyráží do ulic L.A. za spravedlností."},
	  {"jmeno":"Reanimator",
	  "anotace":"Dnes už klasické žánrové dílo na motivy příběhu od H. P. Lovecrafta o zapáleném experimentátorovi Herbertu Westovi, který ve jménu vědy vyrábí násilnické zombie, vzalo elementy klasických hororů třicátých a šedesátých let  s novou zálibou v excesivní tělesnosti, krvavých efektech a černém humoru. "},
	  {"jmeno":"Věc",
	   "anotace":"Vědce z americké výzkumné stanice na Antarktidě vystraší vrtulníkový nájezd jejich norských kolegů, kteří se marně snaží zabít prchajícího psa. Lov dopadne neúspěšně a Norové zmizí bez toho, aby situaci Američanům vysvětlili. Ti však postupně zjišťují, že se psem není něco v pořádku. Je totiž infikovaný mimozemským virem, který pro sebezdokonalování využívá tělesné schránky (nejen) lidí a vůbec mu není proti mysli na svých hostitelích ledacos „zkoušet.“"},
