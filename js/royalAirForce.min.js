"use strict"
function getCookie(e){for(var t=e+"=",n=decodeURIComponent(document.cookie),o=n.split(";"),r=0;r<o.length;r++){var i=o[r]
for(console.log("cookie:",i);" "==i.charAt(0);)i=i.substring(1)
if(0==i.indexOf(t))return i.substring(t.length,i.length)}return""}function setCookie(e,t,n){var o=new Date
o.setTime(o.getTime()+24*n*60*60*1e3)
var r="expires="+o.toUTCString()
document.cookie=e+"="+t+";"+r+";path=/"}function updatePointers(e,t,n,o,r,i,a,l){var s=performance.now()-then
...
u.dx,u.dy,u.parent,m="point_"+u.key,u.parent.classList&&(u.parent!==a?u.parent.classList.remove("current-link"):u.parent.classList.add("current-link")),l&&rightAngledLines(u.parent,u.dx,u.dy,m,t,n,u.parentHeight,u.parentWidth,o,r,i,c,u.disableUnlessPerformant|_removeLines)}),_degree=0,_wasPositive=0}function handleScroll(e){function t(e,t,n,o,r,i,a,l){updatePointers(e,t,n,o,r,i,a,l)}var n=0,o=null,r=[]
pointersRef.forEach(function(e){var t=document.getElementById(e.anchor),i=document.getElementById(e.alt)
null!==i&&void 0!==i||(i=document.getElementById("page-foot"))
var a=60*(.85+n++)-10
document.getElementById(pointersRef[0].alt).getBoundingClientRect().top<a?_scrolledPast=!0:(_scrolledPast=!1,startedScrollingAboveThing=!0)
...
var performanceAverageator=0,performanceCountator=0,_recentlyFired=!1,performantDevice=!0,_degree=0,_wasPositive=0,rightAngledLines=function(e,t,n,o,r,i,a,l,s,d,c,m,u){var p,f,g,v,h=(d-s)/12+i
if(m<c&&(h=Math.max(d/6+(i-s)/6,25)),h=25,document.getElementById(o))p=document.getElementById(o),f=document.getElementById(o+"_ab"),g=document.getElementById(o+"_bc"),v=document.getElementById(o+"_cd"),p.classList.add("animate-transform")
...
n<=0?y=20*(pointersRef.length+_wasPositive-_degree++):(y=20*(pointersRef.length+_degree++),_wasPositive++)
e.appendChild(p),g.style.width="100px",f.style.width=h+y+3+"px",f.style.top=a+"px",g.style.top=Math.min(a-n,a)+1+"px",v.style.top=a-n+"px",g.style.height=Math.abs(n)+3-1+"px",g.style.width="0px",g.setAttribute("class","overlay-line line-vertical"),l=0,f.style.right=l+0+"px",g.style.right=l+h+y+"px",v.style.right=l+h+y+1+"px",v.style.width=t-(l+h+y)+"px",p.style.display="block"}},globalRotations={},_scrolledPast=!1,getOffset=function(e){var t={x:0,y:0}
if(void 0===window.scrollY||void 0===e.getBoundingClientRect())throw new browserIsJankException
return t.x=e.getBoundingClientRect().left+window.scrollX,t.y=e.getBoundingClientRect().top+window.scrollY,t},performanceTempString="",performanceAverageator=0,performanceFinal=0,pointersRef=[{anchor:"harmonogram-link",alt:"harmonogram",x:.58,y:.09},{anchor:"o-akci-link",alt:"o-akci",x:.56,y:.32,hoverEffect:"#heart"},{anchor:"kontakt-link",alt:"kontakt",x:.595,y:.5},{anchor:"cesta-link",alt:"cesta",x:.36,y:.92}]
