      ...
      },
      {
        ...
        "prednasky": [
          ...
          },
          {
            ...
            "anotace": "Vzpřímený postoj a jím uvolněné ruce jsou tím prvním, čím se na vnímatelné rovině liší lidské tělo od těla jiných živých bytostí:<em>Zatím co ostatní tvorstvo je schýleno, k zemi se dívá, člověku vztyčenou tvář on [Prométheus] poskytl, k nebi mu kázal hledět a vzpřímený zrak vždy k hvězdám do výše zdvíhat.</em><br> (Ovidius Proměny I, 84-86).<br>Zajímavost některých způsobů, jimiž jedinečný lidský postoj vysvětlují antičtí myslitelé včetně Platóna i Aristotela, spočívá v tom, že dokáže sloučit naturalistickou fyziologii na straně jedné (vliv srdce a krve) a silně intelektuální představu o smyslu lidské existence na straně druhé: vnitřní fyziologie a na ni vázaná anatomie vzpřímeného postoje umožňuje rozvoj, jehož konečným cílem je rozumová činnost. Podrobnější pohled na vysvětlení tohoto typu rovněž ukáže, proč jeho stopy nečekaně nacházíme i v moderních teoriích, a to včetně teorie evoluční.",
"medailon": "Karel Thein (1961) studoval knihovnictví na FF UK a filosofii na École des Hautes Études en Sciences Sociales ve Francii. Působí na Filozofické fakultě UK, kde se zabývá dějinami filosofie a částečně též filosofií umění včetně otázky obraznosti a její role ve vztahu slov a obrazů. Kromě řady časopiseckých studií a kapitol v monografiích uveřejnil několik knih o antické filosofii (Le lien intraitable, Vynález věcí, Myšlení v nás) a knihu filmových esejů (Rychlost a slzy).",
      ...
      },
      {
        ...
        "prednasky": [
          ...
          },
          {
            ...
            "cas": "17.11. 13-15 (chce být po K. Kolářové)",
          ...
          },
          {
            ...
            "anotace": "Přijďte si poslechnout přednášku týkající se teorie racionální nepozornosti kombinované s klasickou ekonomií. Filip Matějka pomocí ekonomických teorií vysvětluje chování lidí i státu. Vychází z předpokladu, že lidé věnují pozornost jen něčemu. Porozumíte tedy tomu, jak takoví lidé reagují na standardní ekonomické události, jako na změnu daní, úrokových měr nebo jak se orientují na trhu práce. To umožňuje trochu lépe popsat chování reálných nedokonalých lidí. Dozvíte se o behaviorální ekonomii a o tom, jak se lidé umějí a neumějí rozhodovat, a také o tom, k čemu je ekonomický výzkum dobrý a k čemu zatím ne. ",
      ...
      },
      {
        ...
        "prednasky": [
          ...
          },
          {
            ...
            "cas": "17.11. 17-19 (případně 15-17)",
        ...
        "prednasky": [
          {
            ...
            "ref": "PanelovaDiskuseTelesnostZurnalistiky"
          },
          {
            "jmeno": "Lukáš Pollert",
            "cas": " 18.11. 13-15",
